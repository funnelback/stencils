...
<#-- HTML Element.
Usage:  for non-closing elements <@appCore.element type="hr" />
or to nest content: <@appCore.element type="div" id="hello" class="well" custom='data-id="0"'>Hello World!</@appCore.element>
Note:   defaults to nesting/wrapping as a div if nothing is defined.
-->
  ...
  <#if (exhibits)!?size &gt; 0>
    <ol id="search-curator" class="list-unstyled">
      <#list response.curator.exhibits as exhibit>
        ...
        <li>
          <h4><a href="${exhibit.linkUrl}"><@s.boldicize>${exhibit.titleHtml}</@s.boldicize></a></h4>
  ...
  <div id="search-contextual-navigation">
    ...
    <div class="row">
      ...
      <div class="col-md-4 search-contextual-navigation-type">
        ...
        <ul class="list-unstyled">
          <@s.Clusters><li><a href="${s.cluster.href}"> ${s.cluster.label?html?replace("...", " <strong>"+s.contextualNavigation.searchTerm?html+"</strong> ")}</a></li></@s.Clusters>
...
<#macro SearchHistory>
  ...
  <#if session.searchHistory?? && (session.searchHistory?size &gt; 1 || session.searchHistory[0].searchParamsSignature != qsSignature)>
...
<#macro jsDefault>
  ...
  <script src="${SearchPrefix}thirdparty/bootstrap-3.3.2/js/bootstrap.min.js"></script>
