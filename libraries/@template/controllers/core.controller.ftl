...
<#---
	...
	The <code>core.controller.ftl contains only the application logic.
-->
<#escape x as x?html>
<#--
	##############################################################
...
<#---
	Sets up the namespace variables required for create select options by iterating
