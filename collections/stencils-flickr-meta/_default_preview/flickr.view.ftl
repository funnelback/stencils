...
<#macro Result>
	...
	<!-- flickr.view.ftl :: Result -->
		<div id="result-${core_controller.result.rank!}" class="panel panel-default" data-flickr-photo-id="${core_controller.result.metaData.stencilsFlickrPhotoID!}">
...
<#macro ResultModal>
	...
	<div class="modal fade" id="result-modal-${core_controller.result.rank!}" tabindex="-1" role="dialog" aria-labelledby="result-${core_controller.result.rank!}" aria-hidden="true">
