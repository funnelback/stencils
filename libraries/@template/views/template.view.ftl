<#ftl encoding="utf-8" />
<#---
	This file is a starter template for creating new view libraries.
...
<#assign templateResourcesPrefix = "/stencils/resources/template/" >
...
<#-- Import Controller -->
<#import "${librariesPrefix}template/controllers/template.controller.ftl" as template_controller/>
...
<#macro CSS>
	...
	<link rel="stylesheet" href="${templateResourcesPrefix}css/template.css">
</#macro>
...
<#macro JS>
	...
	<script src="${templateResourcesPrefix}js/template.js"></script>
</#macro>
<#-- @end --><#-- /Configuration -->
<#-- ###################  Views ####################### -->
<#-- @begin  ... -->
