...
<#macro JS>
	...
	<script src="${StencilsThirdpartyResourcesPrefix}bootstrap-3.3.5-dist/js/bootstrap.min.js"></script>
...
<#macro ResultsViewSelectorLimit>
	...
	<@base_controller.ResultsViewGrid>
...
<#macro ResultModal>
	<!-- base.view.ftl :: ResultDefaultModal -->
		<div class="modal fade" id="result-modal-${core_controller.result.rank!}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
