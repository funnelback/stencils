...
<head>
  ...
  <@s.OpenSearch />
  <@s.AfterSearchOnly><link rel="alternate" type="application/rss+xml" title="Search results for ${question.inputParameterMap["query"]!?html}<@s.IfDefCGI name="query">,&nbsp;</@s.IfDefCGI><@s.cfg>service_name</@s.cfg>" href="?collection=<@s.cfg>collection</@s.cfg>&amp;query=${question.inputParameterMap["query"]!?url}&amp;form=rss&amp;sort=date"></@s.AfterSearchOnly>

  <title><@s.AfterSearchOnly>${question.inputParameterMap["query"]!?html}<@s.IfDefCGI name="query">,&nbsp;</@s.IfDefCGI></@s.AfterSearchOnly><@s.cfg>service_name</@s.cfg>, Funnelback Search</title>
  ...
  <@s.InitialFormOnly>
    <div class="row search-initial">
        <div class="col-md-6 col-md-offset-3 text-center">
          ...
          <a href="http://funnelback.com/"><img src="${SearchPrefix}funnelback-logo-small-v2.png" alt="Funnelback logo"></a>
          <br><br>
          ...
          <form action="${question.collection.configuration.value("ui.modern.search_link")}" method="GET" role="search">
            ...
            <@s.IfDefCGI name="lang"><input type="hidden" name="lang" value="${question.inputParameterMap["lang"]!?html}"></@s.IfDefCGI>
            <@s.IfDefCGI name="profile"><input type="hidden" name="profile" value="${question.inputParameterMap["profile"]!?html}"></@s.IfDefCGI>
            <div class="input-group">
              <input required name="query" id="query" title="Search query" type="text" value="${question.inputParameterMap["query"]!?html}" accesskey="q" placeholder="Search <@s.cfg>service_name</@s.cfg>&hellip;" class="form-control input-lg query">
      ...
      <div class="collapse navbar-collapse">
        <form class="navbar-form navbar-left form-inline" action="${question.collection.configuration.value("ui.modern.search_link")}" method="GET" role="search">
          ...
          <div class="form-group">
            <input required name="query" id="query" title="Search query" type="text" value="${question.inputParameterMap["query"]!?html}" accesskey="q" placeholder="Search <@s.cfg>service_name</@s.cfg>&hellip;" class="form-control query" data-ng-disabled="isDisplayed('cart') || isDisplayed('history')">
          </div>
              ...
              <div class="col-md-4">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="text" id="query-advanced" name="query" value="${question.inputParameterMap["query"]!?html}" class="form-control input-sm" placeholder="e.g. juliet where thou love">
                    </div>
                  </div>                					
                ...
                <fieldset>
                  ...
                  <div class="form-group">		
                    <label class="control-label col-md-4" for="num_ranks">Results</label>
                      <div class="col-md-8">
                        <div class="input-group">
                          <input type="number" min="1" id="num_ranks" name="num_ranks" placeholder="e.g. 10" value="${(question.inputParameterMap["num_ranks"]!10)?html}" class="form-control input-sm">
              ...
              <div class="col-md-4">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        ...
                        <input type="text" id="origin" name="origin" pattern="-?[0-9\.]+,-?[0-9\.]+" title="Latitude,longitude" placeholder="Latitude, Longitude" value="${question.inputParameterMap["origin"]!?html}" class="form-control input-sm">
                      </div>
                    </div>
                  </div>                                
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <div class="input-group">
                        <input type="number" min="0" id="maxdist" name="maxdist" placeholder="e.g. 10" value="${question.inputParameterMap["maxdist"]!?html}" class="form-control input-sm">
              ...
              <div class="col-md-4">
                <fieldset>
                  ...
                  <div class="form-group">    			
                    ...
                    <div class="col-md-8">
                      <input type="text" id="meta_v" name="meta_v" placeholder="e.g. /plays/romeo-juliet" value="${question.inputParameterMap["meta_v"]!?html}" class="form-control input-sm">
                    </div>
                  </div>
                </fieldset>
      ...
      <div class="col-md-<@s.FacetedSearch>9 col-md-push-3</@s.FacetedSearch><@s.FacetedSearch negate=true>12</@s.FacetedSearch>">
        ...
        <#if question.inputParameterMap["scope"]!?length != 0>
          <div class="breadcrumb">
            <span class="text-muted"><span class="glyphicon glyphicon-resize-small"></span> Scope:</span> <@s.Truncate length=80>${question.inputParameterMap["scope"]!?html}</@s.Truncate>
            <a class="button btn-xs" title="Remove scope: ${question.inputParameterMap["scope"]!?html}" href="?collection=${question.inputParameterMap["collection"]!?html}<#if question.inputParameterMap["form"]??>&amp;form=${question.inputParameterMap["form"]!?html}</#if>&amp;query=<@s.URLEncode><@s.QueryClean /></@s.URLEncode>"><span class="glyphicon glyphicon-remove text-muted"></span></a>
          </div>
        </#if>
        ...
        <div id="search-result-count" class="text-muted">
          ...
          <#if response.resultPacket.resultsSummary.collapsed != 0>
        ...
        <#if response.resultPacket.resultsSummary.totalMatching == 0>
            ...
            <p>Your search for <strong>${question.originalQuery!?html}</strong> did not return any results. Please ensure that you:</p>
            <ul>
              <li>are not using any advanced search operators like + - | " etc.</li> 
              <li>expect this document to exist within the <em><@s.cfg>service_name</@s.cfg></em> collection <@s.IfDefCGI name="scope"> and within <em><@s.Truncate length=80>${question.inputParameterMap["scope"]!?html}</@s.Truncate></em></@s.IfDefCGI></li>
          ...
          <ol id="search-curator" class="list-unstyled">
            <#list response.curator.exhibits as exhibit>
              <#if exhibit.titleHtml?? && exhibit.linkUrl??>
                <li>
                  <h4><a href="${exhibit.linkUrl?html}"><@s.boldicize>${exhibit.titleHtml}</@s.boldicize></a></h4>
                  <#if exhibit.displayUrl??><cite class="text-success">${exhibit.displayUrl?html}</cite></#if>
                  <#if exhibit.descriptionHtml??><p><@s.boldicize>${exhibit.descriptionHtml}</@s.boldicize></p></#if>
                </li>
              </#if>
            </ol>
          </#list>
...
<div id="mapResults"></div>
        <#if (response.resultPacket.bestBets)!?size &gt; 0>
          ...
          <@s.BestBets>
            <li class="alert alert-warning">
              <#if s.bb.title??><h4><a href="${s.bb.clickTrackingUrl?html}"><@s.boldicize>${s.bb.title}</@s.boldicize></a></h4></#if>
              <#if s.bb.title??><cite class="text-success">${s.bb.link?html}</cite></#if>
        ...
        <ol id="search-results" class="list-unstyled" start="${response.resultPacket.resultsSummary.currStart}">
          <@s.Results>
            ...
            <#else>
              <li data-fb-result=${s.result.indexUrl?html}>
                ...
                <cite data-url="${s.result.displayUrl?html}" class="text-success"><@s.cut cut="http://"><@s.boldicize>${s.result.displayUrl?html}</@s.boldicize></@s.cut></cite>
                <div class="btn-group">
                ...
                <div class="row">
                  <@s.Category name="type">
                    <div class="col-md-4 search-contextual-navigation-type">
                      ...
                      <ul class="list-unstyled">
                        <@s.Clusters><li><a href="${s.cluster.href?html}"> ${s.cluster.label?replace("...", " <strong>"+s.contextualNavigation.searchTerm+"</strong> ")}</a></li></@s.Clusters>
                        <@s.ShowMoreClusters category="type"><li><a rel="more" href="${changeParam(s.category.moreLink, "type_max_clusters", "40")?html}" class="btn btn-link btn-sm"><small class="glyphicon glyphicon-plus"></small> More&hellip;</a></li></@s.ShowMoreClusters>
                  ...
                  <@s.Category name="topic">
                      <div class="col-md-4 search-contextual-navigation-topic">
                        ...
                        <ul class="list-unstyled">
                          <@s.Clusters><li><a href="${s.cluster.href?html}"> ${s.cluster.label?replace("...", " <strong>"+s.contextualNavigation.searchTerm+"</strong> ")}</a></li></@s.Clusters>
                          <@s.ShowMoreClusters category="topic"><li><a rel="more" href="${changeParam(s.category.moreLink, "topic_max_clusters", "40")?html}" class="btn btn-link btn-sm"><small class="glyphicon glyphicon-plus"></small> More&hellip;</a></li></@s.ShowMoreClusters>
                  ...
                  <@s.Category name="site">
                      <div class="col-md-4 search-contextual-navigation-site">
                        ...
                        <ul class="list-unstyled">
                          <@s.Clusters><li><a href="${s.cluster.href?html}"> ${s.cluster.label}</a></li></@s.Clusters>
                          <@s.ShowMoreClusters category="site"><li><a rel="more" href="${changeParam(s.category.moreLink, "site_max_clusters", "40")?html}" class="btn btn-link btn-sm"><small class="glyphicon glyphicon-plus"></small> More&hellip;</a></li></@s.ShowMoreClusters>
        ...
        <div class="text-center hidden-print">
          ...
          <ul class="pagination pagination-lg">
            ...
            <@fb.Page numPages=5><li <#if fb.pageCurrent> class="active"</#if>><a href="${fb.pageUrl?html}">${fb.pageNumber}</a></li></@fb.Page>
  ...
  <footer>
    ...
    <p class="text-muted text-center"><small>
      ...
      Search powered by <a href="http://www.funnelback.com">Funnelback</a>.  Template uses <a href="http://getbootstrap.com/">Bootstrap</a> and <a href="http://glyphicons.getbootstrap.com/">Glyphicons</a>.
    </small></p>
  </footer>
</div>
...
<script>
  jQuery(document).ready( function() {
    ...
    jQuery("input.query").fbcompletion({
      ...
      'profile'    : '${question.inputParameterMap["profile"]!?html}'
    });
