  ...
  <body id="funnelback-search" class="container<#if layoutType?? && layoutType != ''>-${layoutType}</#if> "<#if question.collection.configuration.valueAsBoolean("ui.modern.session")> data-ng-app="Funnelback" data-ng-controller="DefaultCtrl" </#if> data-ng-show="isDisplayed('results')">
    ...
    <@s.AfterSearchOnly>
        ...
        <section id="search-main">
          ...
          <div id="search-content" data-stencils-map data-stencils-mapdataurl="<@places_controller.GetMapDataURL />" data-stencils-mapid="map" class="col-lg-${(12-colWidth)?string} col-sm-12" data-stencils-map-defaulttile="googleRoadmap" style="height:50%!important">
          ...
          <div id="search-content" data-stencils-map data-stencils-mapdataurl="<@places_controller.GetMapDataURL />" data-stencils-mapid="map" class="col-lg-${(12-colWidth)?string} col-sm-12" data-stencils-map-defaulttile="googleTerrain" style="height:50%!important">
            <#if places_view.MapMarkerPopup??><@places_view.MapMarkerPopup mapId="map2" /></#if>
            <div id="mapsMapView" style="height:100%;">
              <div id="mapResults" data-mapdiv></div>
            </div>
          </div>
